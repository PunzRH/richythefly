...
class StonkflyActions(ActionProvider):
    def __init__(self, guard, broker):
        ...
        self.broker = broker
        self.quotes = {}
        self.budget = None        # ETH the fly wants to spend this tick (None = fixed limit)
        self.sell_fraction = None  # share of the position the fly wants to sell
    ...
    def invoke(self, args):
        ...
        plan = self.guard.plan(p.product, p.side, self.quotes, budget=self.budget, sell_fraction=self.sell_fraction)
